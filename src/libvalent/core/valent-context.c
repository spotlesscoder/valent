 ...
 */
ValentContext *
valent_context_new_for_plugin (ValentContext  *parent,
                               PeasPluginInfo *plugin_info)
{
  g_return_val_if_fail (parent == NULL || VALENT_IS_CONTEXT (parent), NULL);
 ...
 */
const char *
valent_context_get_cache_path (ValentContext *context)
{
 ...
 */
const char *
valent_context_get_data_path (ValentContext *context)
{
  ValentContextPrivate *priv = valent_context_get_instance_private (context);
...
/**
 * valent_context_create_cache_file:
 * @context: a #ValentContext
 ...
 */
GFile *
valent_context_create_cache_file (ValentContext *context,
                                  const char    *filename)
{
  ValentContextPrivate *priv = valent_context_get_instance_private (context);
...
/**
 * valent_context_create_config_file:
 * @context: a #ValentContext
 * @filename: (type filename): a filename
 *
 ...
 */
GFile *
valent_context_create_config_file (ValentContext *context,
                                   const char    *filename)
{
  ValentContextPrivate *priv = valent_context_get_instance_private (context);
...
/**
 * valent_context_create_data_file:
 * @context: a #ValentContext
 * @filename: (type filename): a filename
 *
 ...
 */
GFile *
valent_context_create_data_file (ValentContext *context,
                                 const char    *filename)
{
  ValentContextPrivate *priv = valent_context_get_instance_private (context);
...
/**
 * valent_context_create_plugin_settings:
 * @context: a #ValentContext
 * @plugin_info: a #PeasPluginInfo
 ...
 */
GSettings *
valent_context_create_plugin_settings (ValentContext  *context,
                                       PeasPluginInfo *plugin_info,
 ...
 */
GFile *
valent_context_get_file (const char *dirname,
                         const char *basename,
                         gboolean    unique)
{
